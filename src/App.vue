  ...
  <v-app id="inspire">
    <v-navigation-drawer  v-model="drawer" app disable-resize-watcher>
      <v-list dense>
        ...
        <v-list-item link>
          <v-list-item-content>
            <v-list-item-title>Minería & Petróleo</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
        <v-list-item link>
          <v-list-item-content>
        ...
        <v-list-item link>
          <v-list-item-content>
            <v-list-item-title>Servicios Públicos</v-list-item-title>
          </v-list-item-content>
        </v-list-item>
         <v-list-item link>
          <v-list-item-content>
      ...
      <v-spacer></v-spacer>
        ...
        <v-menu offset-y>
          <template v-slot:activator="{ on }">
            <v-btn outlined class="mr-4" depressed color="white" v-on="on" v-ripple="{ center: true }" :ripple="{ class: 'green--text' }">
