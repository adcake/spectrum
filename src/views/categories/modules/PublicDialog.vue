    ...
    <v-row justify="center">
      <v-dialog v-model="dialog" fullscreen hide-overlay transition="dialog-bottom-transition">
        <template v-slot:activator="{ on }">
          <v-btn small rounded color="primary" dark v-on="on">Ver Más</v-btn>
        </template>
        <v-card>
                ...
                <v-row no-gutters>
                  ...
                  >
                    <v-img
                      ...
                      alt="alt"
                    ></v-img>
                    <v-list three-line subheader v-if="radiopic.text1">
                      <v-list-item>
                        <v-list-item-content>
                        ...
                        <v-container>
                          <div class="px-2">
                            <v-card class="py-5" flat shaped v-if="description.description2">
                              <v-row>
                                <v-col xs="12" sm="8" class="align-self-center">
                                ...
                                <v-col xs="12" sm="4">
                                  <div class="px-2">
                                    <v-img width="auto" contain :src="description.image2" />
                                  ...
                                  <v-container fluid grid-list-xs>
                                    <v-row no-gutters>
                                      <v-col
                                        ...
                                        sm="6"
                                        md="3"
                                        class="align-self-center text-center py-3"
                                        v-for="logos in item.brandLogos"
                                        :key="logos.id"
                                      >
                                        <v-img height="50" aspect-ratio="2" contain :src="logos.src" alt="alt"></v-img>
                                      </v-col>
                                    </v-row>
                                  </v-container>
                                </v-flex>
                                ...
                                <template>
                                  <v-list-item>
                                    <v-list-item-avatar class="align-self-center">
                                      <v-icon large>{{ list.iconListing }}</v-icon>
                                    </v-list-item-avatar>

                                    <v-list-item-content>
                                      <v-list-item-title v-if="list.preListing"
                                        ><span class="title font-weight-bold black--text text-left">{{
                                          list.preListing
                                        }}</span></v-list-item-title
                                      >
                                      <p v-if="list.listing" class="body-1 text-justify px-0 py-1">
                                        {{ list.listing }}
                                      </p>
                                    </v-list-item-content>
                                  </v-list-item>
...
<script src="@/views/categories/js/PublicDialog.js"></script>
