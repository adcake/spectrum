...
export default {
  ...
  data: () => ({
    ...
    miningCards: [
      ...
      {
        title: "Minería",
        subtitle: "Soluciones especializadas en minería",
        src: require("@/assets/home/industrias11.jpg"),
        titlePop: "Comunicaciones para la atención médica crítica.",
        texts: [{}, {}],

        picList1: [
          { src: require("@/assets/images/props/mining2/radio1.jpg"), text1: "Sepura", text2: "STP9100" },
          { src: require("@/assets/images/props/mining2/radio5.jpg"), text1: "Hytera", text2: " PT790X" },
          { src: require("@/assets/images/props/mining2/radio6.jpg"), text1: "Icom", text2: "IC-F4202DEX" },
          {
            src: require("@/assets/images/props/mining2/radio4.jpg"),
            text1: "Kenwood",
            text2: "Kenwood NX-5000 Series",
          },
        ],
        ...
        description: [
          {
            ...
            headerPic: "",
            imageHeaderPic: require("@/assets/images/props/mining2/header.jpg"),
            subtitle: "Soluciones para ciudades inteligentes.",
            description:
              "Nuestras completas soluciones especializadas le brindan una poderosa red de datos y voz que puede automatizar y agilizar procesos esenciales, brindando datos precisos y consistentes en tiempo real, mayor seguridad de los trabajadores y una protección de activos superior.",
            description1:
              "Altamente seguro, y sin un solo punto de falla, nuestros sistemas pueden mantenerlo en comunicación cuando otros sistemas fallan. Y nuestros terminales resistentes pueden lidiar con algunas de las condiciones más duras de la tierra y sin comprometer la funcionalidad.",
            description2:
              "Con opciones intrínsecamente seguras que cumplen con los estándares IECEx / ATEX, nuestras soluciones especializadas proporcionan una poderosa red de voz y datos que puede automatizar y agilizar procesos esenciales, proporcionando una mayor seguridad en el sitio y una protección de activos superior.",
            image2: require("@/assets/images/props/radios.jpg"),
            image2Description: "TETRA & DMR Radios, Sistemas & Aplicaciones",
            description3:
              "La seguridad del trabajador se prioriza a través de funciones como Man-Down, que usa sensores de movimiento para detectar la falta de movimiento, y Lone Worker, que se puede configurar para realizar una llamada de emergencia si se detecta un cambio de estado.",
            description4:
              "Las compañías mineras más grandes del mundo confían en nuestras marcas para su seguridad y funcionamiento.",
            image4: require("@/assets/images/props/mining2/image2.jpg"),
            image4Description: "NEXEDGE NXDN and NEXEDGE DMR ",
          },
        ],
        picList2: [
          {
            src: require("@/assets/images/teltronic/pbs2.jpg"),
            text1: "Teltronic / eNEBULA TETRA ",
            text2: "PBS2 Portátil",
          },
        ...
        descriptionList: [
          {
            ...
            preListing: "POSICIONAMIENTO GLOBAL",
            listing: "Servicios de localización GPS incluidos para seguimiento, disparadores y respuesta de emergencia",
          },
          {
            iconListing: "filter_hdr",
            preListing: "RESISTENTE",
            listing:
              "Los auriculares resistentes y el audio nítido garantizan una comunicación precisa, por ruidosa que sea el entorno.",
          },
          {
            iconListing: "signal_cellular_alt",
            preListing: "COBERTURA y ACCESO",
            listing: "Las puertas de enlace móviles van contigo para extender la cobertura, incluso en puntos muertos.",
          },
          {
            iconListing: "radio_button_checked",
            preListing: "COMUNICACIÓN DEL EQUIPO",
            listing: "Los grupos de conversación permiten que los equipos individuales se comuniquen simultáneamente.",
          },
          {
            iconListing: "dvr",
            preListing: "RASTREAR E INFORMAR",
            listing:
          ...
          {
            iconListing: "scatter_plot",
            preListing: "A PRUEBA DE POLVO",
            listing:
              "Todas las radios portátiles de Sepura tienen clasificaciones de protección ambiental, lo que significa que el dispositivo es a prueba de polvo.",
          },
          {
            iconListing: "flare",
            preListing: "ERGONOMICOS",
            listing:
              "Las radios y accesorios de diseño ergonómico permiten una operación rápida y fácil, incluso con manos enguantadas.",
          },
          {
            iconListing: "phone_in_talk",
            preListing: "VOZ Y DATOS",
            listing:
              "Las comunicaciones simultáneas de voz y datos permiten compartir información en tiempo real con el personal de campo y la sala de control.",
          },
          {
            iconListing: "my_location",
            preListing: "GPS",
            listing:
              "Características como Lone Worker y Man-Down se combinan con una ubicación precisa del GPS para garantizar la seguridad del personal.",
          },
          {
            iconListing: "layers",
            preListing: "ACCESORIOS MINEROS",
            listing:
              "El exclusivo sRSM Dustguard garantiza un audio intacto incluso en presencia de polvo de mineral de hierro magnético.",
          },
        ],
      },
      ...
      ///Petroleo
      {
        ...
        src: require("@/assets/home/industrias10.jpg"),
        titlePop: "Infraestructuras Críticas.",
        texts: [{}, {}],

        picList1: [
          { src: require("@/assets/images/props/mining/radio0.jpg"), text1: "Sepura", text2: "STP8X100" },
          { src: require("@/assets/images/props/mining/radio1.jpg"), text1: "Hytera", text2: "PT790" },
          { src: require("@/assets/images/props/mining/radio2.jpg"), text1: "Kenwood", text2: "NX-330EXE" },
          { src: require("@/assets/images/props/mining/radio3.jpg"), text1: "Icom", text2: "F3201DEX / F4201DEX" },
        ],
        ...
        picList3: [
          {
            src: require("@/assets/images/props/mining/picList3_1.jpg"),
            text1: "Cámaras térmicas",
            text2: "HikvisionDS-2TD2466-50Y",
          },
          {
            src: require("@/assets/images/props/mining/picList3_2.jpg"),
            text1: "Cámaras protegidas contra explosiones",
            text2: "DS-2XE6126FWD-HS",
          },
          {
            src: require("@/assets/images/props/mining/picList3_3.jpg"),
        ...
        descriptionList: [
          ...
          {
            iconListing: "zoom_out_map",
            preListing: "FLEXIBILIDAD Y ESCALABILIDAD",
            listing: "Desde pequeñas operaciones en un solo sitio hasta redes nacionales",
          },
          {
            iconListing: "location_on",
            preListing: "GEOFENCING",
            listing:
              "Geofencing limita el acceso a áreas restringidas, indica movimiento no autorizado de equipos y alerta al personal sobre la proximidad a zonas peligrosas.",
          },
          {
            iconListing: "radio_button_checked",
            preListing: "TIEMPOS RÁPIDOS DE CONFIGURACIÓN DE LLAMADAS",
            listing: "Utilizando Push-To-Talk (PTT) tradicional.",
          },
          {
            iconListing: "visibility",
            preListing: "SCADA",
            listing:
              "Desde pozos de producción hasta tanques de almacenamiento, SCADA permite el monitoreo de equipos remotos, eliminando los viajes a sitios de perforación inaccesibles e instalaciones de almacenamiento, y permite el apagado y recuperación de equipos en caso de emergencia..",
          },
          {
            iconListing: "signal_cellular_alt",
            preListing: "CONECTIVIDAD",
            listing:
              "La conectividad multiplataforma brinda a las cuadrillas acceso a mensajes de texto e imágenes, correo electrónico y datos del sistema de fondo, incluso en ubicaciones remotas.",
          },
          {
            iconListing: "apps",
            preListing: "APLICACIONES PERSONALIZADAS",
            listing:
              "Las aplicaciones personalizables mantienen una pista de auditoría completa y promueven entornos que cumplen con la seguridad, reduciendo incidentes y exposición de responsabilidad.",
          },
        ],
      },
      ...
      ///Energía
      {
        ...
        subtitle: "Garantizar la producción de energía",
        src: require("@/assets/home/industrias13.jpg"),
        titlePop: "Infraestructuras Críticas.",
        texts: [{}, {}],
        ...
        description: [
          {
            ...
            headerPic: "",
            imageHeaderPic: require("@/assets/images/props/electricity/header.jpg"),
            subtitle: "Soluciones comerciales",
            description:
              "Sin electricidad, el mundo se detendría. Spectrum Tecnología dispone de una solución que garantizará la seguridad de sus instalaciones y sus empleados. A veces, controlar la eficiencia de la producción es tan importante como velar por la seguridad de sus instalaciones. Con nuestras soluciones de videovigilancia puede hacer las dos cosas, para que su planta funcione sobre ruedas y al mismo tiempo consiga multiplicar la eficiencia.",
            descriptionListing: [
              {
                listingDes:
                  "Gracias a los avanzados domos PTZ (movimiento horizontal/vertical y zoom) de alta velocidad, podrá disponer de una panorámica general y, al mismo tiempo, ampliar para ver detalles concretos de una acción, incluso después de que se produzca.",
              },
              {
                listingDes:
                  "A través de la obtención periódica de datos de producción de instalaciones remotas, combinada con información visual, podrá aumentar la eficiencia y reducir los tiempos de inactividad.",
              },
              {
                listingDes:
                  "Spectrum Tecnología le ofrece cámaras con refrigeración activa, calefacción para el cristal de la cámara y parasoles ajustables, para que pueda obtener vídeos a temperaturas de entre -50°C y +75°C.",
              },
            ],
            description1: "",
            description2:
            ...
            description4:
              "Las compañías mineras más grandes del mundo confían en nuestras marcas para su seguridad y funcionamiento.",
            image4: require("@/assets/home/industrias14.jpg"),
      ...
      ///Telecomunicaciones
      {
        ...
        subtitle: "Protección total de los sistemas de telecomunicaciones",
        src: require("@/assets/home/industrias14.jpg"),
        titlePop: "Infraestructuras Críticas.",
        texts: [{}, {}],

        picList1: [
          {
            src: require("@/assets/images/props/telecommunication/radio0.jpg"),
            text1: "Teltronic",
            text2: "SBS – Estación base fija",
          },
          {
            src: require("@/assets/images/props/telecommunication/radio1.jpg"),
            text1: "Teltronic",
            text2: "MBS – Estación base de montaje en mástil",
          },
          {
            src: require("@/assets/images/props/telecommunication/radio2.jpg"),
            text1: "Teltronic",
            text2: "DBS – Estación base táctica",
          },
          { src: require("@/assets/images/props/telecommunication/radio4.jpg"), text1: "Sepura", text2: "STP9000" },
        ],
        ...
        description: [
          {
            ...
            title: "Protección de sus propiedades y beneficios",
            headerPic: "",
            imageHeaderPic: require("@/assets/images/props/telecommunication/header.jpg"),
            subtitle: "Soluciones comerciales",
            description:
              "El mundo de hoy está impulsado por los servicios públicos. Desde el saneamiento hasta el suministro de energía, nuestra sociedad depende de redes sofisticadas para garantizar nuestro bienestar nacional y la continuidad de nuestros negocios. Nuestras soluciones en seguridad electrónica ayudan a mantener el flujo de agua, gas y electricidad:",
            descriptionListing: [
              {
                listingDes:
                  "Nuestras soluciones le permitirá obtener imágenes nítidas e identificables y, en situaciones de oscuridad absoluta, nuestras cámaras térmicas podrán detectar y vigilar cualquier posible amenaza.",
              },
              {
                listingDes:
            ...
            description2Listing: [
              ...
              {
                listingDes:
                  "Soluciones de interoperabilidad que facilitan la comunicación con entidades externas como cuerpos y fuerzas de seguridad pública que colaborar con la seguridad privada de la infraestructura en un momento puntual.",
              },
              {
                listingDes:
                  "Supervisión de zonas de forma remota, inspeccionar y comprobar visualmente que las funciones y procesos funcionan correctamente.",
              },
              {
                listingDes:
                  "Garantizar que se siguen las reglas y los procesos de seguridad y que las herramientas y los equipos se gestionan correctamente.",
            ...
            description3: "",
            description4:
              "Nuestras marcas han estado trabajando por más de 40 años diseñando, fabricando y desplegando sistemas de comunicación para voz y datos en instalaciones críticas.",
            image4: require("@/assets/images/props/mining/picList3_4.jpg"),
            image4Description: "Perimeter Defender DS-PI-Q250",
          },
        ],
        picList2: [
          {
        ...
        descriptionList: [
          ...
          {
            iconListing: "radio_button_checked",
            preListing: "Control de Acceso",
            listing:
              "Asegure las entradas de las puertas sin operario y otras aplicaciones de control de acceso. Capture automáticamente imágenes de la matrícula de los vehículos que acceden a sus instalaciones y realice las acciones adecuadas, como abrir una puerta o generar una alerta, reconocer, identificar o verificar personal autorizado.",
          },
          {
            iconListing: "dvr",
            preListing: "Integración con la operación de la instalación",
            listing:
              "Posibilidad de integrar con otros subsistemas como controles de accesos, sistemas de control telemétrico de la instalación, etc.",
          },
          {
            iconListing: "dynamic_feed",
            preListing: "Gestión de redundancias",
            listing:
              "Máxima disponibilidad y confiabilidad de las soluciones desplegadas.Tanto en el acceso a red, bandas, aplicaciones de voz y datos críticos, como en las aplicaciones de vídeo que se basan en tecnología IP, codificación H.264 y son compatibles con estándares ONVIF. Instalación, despliegue y capacidad de los sistemas escalables 100% IP. Mantenimiento eficiente y distribuído",
          },
        ],
      },
    ],
    ...
    itemsSpec: [
      {
        title: "Control de los procesos de diseño y fabricación",
        text: "Personalización de los productos y soluciones.",
        text2:
          "Flexibilidad en integración de todas las soluciones suministradas por TELTRONIC con soluciones complementarias o sistemas existentes.",
      },
      {
        title: "Gran variedad de soluciones de acuerdo a la funcionalidad requerida",
        text: "Adaptación a los requisitos de cada proyecto.",
      },
      {
        title: "Seguimiento completo del proyecto en todas sus fases",
        text:
          "Desde la planificación previa con estudios de cobertura a la atención de postventa cuando los sistemas ya se encuentran en funcionamiento",
      },
      {
        title: "Evolución y modernización continua de los productos y soluciones",
        text:
          "Incorporación constante de nuevas funcionalidades y mejoras sobre los productos, manteniéndolos actualizados a las últimas tendencias de mercado",
      },
      {
        title: "Fiabilidad y disponibilidad máximas",
        text: "Redundancia de elementos.",
        text2:
          "Soluciones de monitorización y control para un mantenimiento preventivo que garantice el perfecto funcionamiento de los sistemas",
      },
      {
        title: "Componentes y elementos estándar",
        text:
          "Asegurando el acceso a economías de escala para reducir los costes a la vez que se evita la obsolescencia de los dispositivos.",
      },
      {
        title: "Sistema unificado multi-servicio",
        text:
          "Soportando varias aplicaciones y servicios desde los mismos sistemas y soluciones, con lo que se reduce tanto la inversión inicial como los costes de mantenimiento.",
      },
      {
        title: "Solución 100% IP, tanto para señalización como para transporte de voz y datos de usuario",
        text:
          "Reducción del ancho de banda requerido en la red de transporte y en el coste de los elementos intermedios de conmutación",
      },
      {
        title: "Escalabilidad y soluciones con capacidad de crecimiento",
        text:
          "Para la expansión futura de la red, la integración de nuevos servicios o la evolución hacia nuevas versiones de los estándares.",
      },
    ],
  }),
