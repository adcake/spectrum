  ...
  data: () => ({
    ...
    miningCards: [
        ...
        descriptionList: [
          {
            ...
            listing:
              "Calidad de vídeo HDTV con imagen estable a pesar de las vibraciones y el movimiento del vehículo.",
          },
          {
          ...
          },
          {
            ...
            listing:
              "Tecnología inteligente de ahorro de ancho de banda: capture más detalles con menos ancho de band.",
          },
        ],
      },
      ...
      ///Aviacion
      {
        ...
        picList1: [
          { src: require("@/assets/images/props/aviation/radio0.jpg"), text1: "Icom", text2: "A25c" },
          { src: require("@/assets/images/props/aviation/radio1.jpg"), text1: "Kenwood", text2: "TH-D74e" },
          { src: require("@/assets/images/props/aviation/radio2.jpg"), text1: "Sepura", text2: "SC21" },
          { src: require("@/assets/images/props/aviation/radio3.jpg"), text1: "Hytera", text2: "PD782I" },
        ],
        ...
        description: [
          {
            ...
            descriptionListing: [
              {
                listingDes: "Comunicaciones radio TETRA y LTE. Equipamiento para infraestructuras de red de transporte",
              },
              {
                listingDes: "Equipos radio embarcados.",
              },
              {
                listingDes: "Consolas embarcadas para interfaz de usuario.",
              },
              {
                listingDes: "Integración con soluciones de megafonía e interfonía.",
              },
              {
                listingDes: "Radios móviles y portátiles.",
              },
              {
                listingDes:
              ...
              {
                listingDes: "Aplicaciones especialmente diseñadas para centros de control de transporte: CeCo-TRANS.",
              },
              {
                listingDes: "Unidades de despacho para estaciones y centros de control.",
              },
            ],
            description1:
            ...
            description2Listing: [
              {
                listingDes: "Alertas automáticas cuando alguien accede al perímetro o área restringida (día y noche)",
              },
              {
                listingDes:
              ...
              {
                listingDes: "Inteligencia integrada que permite el conteo de personas y la detección de movimiento",
              },
              {
                listingDes:
        ...
        descriptionList: [
          ...
          },
          {
            ...
            listing: "Integración completa con otros sistemas aeroportuarios existentes.",
          },
          {
            iconListing: "signal_cellular_alt",
        ...
        descriptionList: [
          {
            ...
            listing: "Mantenga la comunicación fluyendo donde otros sistemas fallarían",
          },
          {
            iconListing: "filter_hdr",
            preListing: "DE CONFIANZA",
            listing: "Terminales robustos y resistentes del mercado.",
          },
          {
            iconListing: "signal_cellular_alt",
            preListing: "SEGURIDAD AVANZADA",
            listing: "Maximice la seguridad de los trabajadores en todo momento.",
          },
        ],
      },
